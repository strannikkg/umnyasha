...
function openTab(t){var e,a;for(a=document.getElementsByClassName("containerTab"),e=0;e<a.length;e++)a[e].style.display="none";document.getElementById(t).style.display="block"}function slowScroll(t){return $("html, body").animate({scrollTop:$(t).offset().top-0},1e3),!1}function r(t){/in/.test(document.readyState)?setTimeout("r("+t+")",9):t()}$(document).ready((function(){$(".owl-carousel-3").owlCarousel({loop:!0,margin:10,nav:!0,navText:["<div class='nav-btn prev-slide'></div>","<div class='nav-btn next-slide'></div>"],pagination:!1,dots:!1,autoplay:!1,autoHeight:!0,responsive:{0:{items:1},768:{items:2},1400:{items:3}}}),$(".owl-carousel-5").owlCarousel({loop:!0,margin:10,nav:!0,navText:["<div class='nav-btn prev-slide'></div>","<div class='nav-btn next-slide'></div>"],dots:!1,autoplay:!1,autoHeight:!0,responsive:{0:{items:2},768:{items:3},1280:{items:4},1400:{items:5}}}),$(".gallery").magnificPopup({delegate:"a",type:"image",mainClass:"mfp-with-zoom",preload:[1,3],zoom:{enabled:!0,duration:300,easing:"ease-in-out",opener:function(t){return t.is("img")?t:t.find("img")}},tLoading:"Загружается изображение #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},callbacks:{lazyLoad:function(t){console.log(t)}},image:{tError:'<a href="%url%">Это изображение #%curr%</a> не может быть отображено.',titleSrc:function(t){return t.el.attr("title")+"<small>Фотоархив УмНяши</small>"}}}),$(".simple-ajax-popup-align-top").magnificPopup({type:"ajax",alignTop:!0,overflowY:"scroll"}),$(".simple-ajax-popup").magnificPopup({type:"ajax"}),$(".popup-youtube, .popup-vimeo, .popup-gmaps").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),$(".image-popup-vertical-fit").magnificPopup({type:"image",closeOnContentClick:!0,mainClass:"mfp-img-mobile",image:{verticalFit:!0}}),$(".image-popup-fit-width").magnificPopup({type:"image",closeOnContentClick:!0,image:{verticalFit:!1}}),$(".image-popup-no-margins").magnificPopup({type:"image",closeOnContentClick:!0,closeBtnInside:!1,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},zoom:{enabled:!0,duration:300}}),$("#phone").mask("+7 (999) 999-99-99"),$("#phone1").mask("+7 (999) 999-99-99"),$(".inlineform").append('<input type="hidden" name="org" value="" class="_org">'),$(".homeform").append('<input type="hidden" name="org" value="" class="_org">');function t(){if($(".ajax-filter-count").length){var t=$(".ajax-filter-count").data("count");$(".ajax-count").text(t)}else $(".ajax-count").text($(".ajax-item").length)}function e(){$.ajax({data:$(".ajax-form").serialize()}).done((function(e){var a=$(e);$(".ajax-container").fadeOut(200),setTimeout((function(){$(".ajax-container").html(a.find(".ajax-container").html()).fadeIn(200),t()}),200)}))}t(),$(".ajax-container").on("click",".ajax-more",(function(t){t.preventDefault();var e=$(".ajax-item").length;$.ajax({data:$(".ajax-form").serialize()+"&offset="+e}).done((function(t){$(".ajax-more").remove();var e=$(t);e.find(".ajax-item").hide(),$(".ajax-container").append(e.find(".ajax-container").html()),$(".ajax-item").fadeIn()}))})),$(".ajax-start").click((function(t){t.preventDefault(),e()})),$(".ajax-reset").click((function(a){a.preventDefault(),$(".ajax-form").trigger("reset"),$("input[name=sortby]").val("pagetitle"),$("input[name=sortdir]").val("asc"),setTimeout((function(){$("[data-sort-by]").data("sort-dir","asc").toggleClass("button-sort-asc").text("По возрастанию")}),200),e(),t()})),$(".ajax-form input").change((function(){e()})),$("[data-sort-by]").data("sort-dir","asc").click((function(){var t=$(this);$("input[name=sortby]").val($(this).data("sort-by")),$("input[name=sortdir]").val($(this).data("sort-dir")),setTimeout((function(){$("[data-sort-by]").not(this).toggleClass("button-sort-asc").text("По возрастанию"),"asc"==t.data("sort-dir")?t.data("sort-dir","desc").text("По убыванию"):t.data("sort-dir","asc").text("По возрастанию"),$(this).toggleClass("button-sort-asc")}),200),e()}))})),function(t){t(window).scroll((function(){t(this).scrollTop()>100?t("#back-to-top").fadeIn():t("#back-to-top").fadeOut()})),t("#back-to-top").click((function(){return t("body,html").animate({scrollTop:0},800),!1}))}(jQuery),r((function(){if(document.getElementsByClassName)t=document.getElementsByClassName("youtube");else var t=function(t,e){for(var a=[],i=new RegExp("(^| )"+e+"( |$)"),n=t.getElementsByTagName("*"),o=0,s=n.length;o<s;o++)i.test(n[o].className)&&a.push(n[o]);return a}(document.body,"youtube");for(var e=t.length,a=0;a<e;a++){t[a].style.backgroundImage="url(https://i.ytimg.com/vi/"+t[a].id+"/sddefault.jpg)";var i=document.createElement("div");i.setAttribute("class","play"),t[a].appendChild(i),t[a].onclick=function(){var t=document.createElement("iframe"),e="https://www.youtube.com/embed/"+this.id+"?autoplay=1&autohide=1";this.getAttribute("data-params")&&(e+="&"+this.getAttribute("data-params")),t.setAttribute("src",e),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen","allowfullscreen"),t.style.width=this.style.width,t.style.height=this.style.height,this.parentNode.replaceChild(t,this)}}}));